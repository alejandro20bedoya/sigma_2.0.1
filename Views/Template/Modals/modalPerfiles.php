<!-- Modal -->
<div class="modal fade" id="modalFormUsuarioperfil" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                        ...
                        <form id="formUsuarioperfil" name=" formUsuarioperfil" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="modal-body user-fields">
                                ...
                                <input type="text" class="form-control valid validText" id="txtNombresUsuario"
                                    name="txtNombresUsuario" maxlength="30"
                                    onkeypress="return controlTag(event);">
                            </div>
                            ...
                            <div class="modal-body user-fields">
                                ...
                                <input type="text" class="form-control valid validText" id="txtApellidosUsuario"
                                    name="txtApellidosUsuario" maxlength="30"
                                    onkeypress="return controlTag(event);">
                            </div>
                            ...
                            <div class="modal-body user-fields">
                                ...
                                <input type="text" class="form-control valid validText" id="txtCelularUsuario"
                                    name="txtCelularUsuario" maxlength="30"
                                    onkeypress="return controlTag(event);">
                            </div>
                            ...
                            <div class="modal-body user-fields">
                                ...
                                <input type="text" class="form-control valid validText" id="txtCorreoUsuario"
                                    name="txtCorreoUsuario" maxlength="30"
                                    onkeypress="return controlTag(event);">
                            </div>

                            <!-- DIV separado para la foto -->
                            <div class="mb-3">
                                <label for="fotoUsuario">Foto de perfil</label>
                                <input type="file" class="form-control" id="fotoUsuario"
                                    name="fotoUsuario" accept="image/*">
                            </div>
